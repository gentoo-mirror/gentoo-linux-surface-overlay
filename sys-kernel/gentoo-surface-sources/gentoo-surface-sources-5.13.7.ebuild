...
src_prepare() {
	...
	eapply -p0 "${DISTDIR}/0001-surface3-oemb.patch"
	eapply -p0 "${DISTDIR}/0002-mwifiex.patch"
	eapply -p0 "${DISTDIR}/0003-ath10k.patch"
	eapply -p0 "${DISTDIR}/0004-ipts.patch"
	eapply -p0 "${DISTDIR}/0005-surface-sam-over-hid.patch"
	eapply -p0 "${DISTDIR}/0006-surface-sam.patch"
	eapply -p0 "${DISTDIR}/0007-surface-hotplug.patch"
	eapply -p0 "${DISTDIR}/0008-surface-typecover.patch"
	eapply -p0 "${DISTDIR}/0009-cameras.patch"
	eapply -p0 "${DISTDIR}/0010-amd-gpio.patch"
	eapply -p0 "${DISTDIR}/0011-amd-s0ix.patch"
	eapply_user
